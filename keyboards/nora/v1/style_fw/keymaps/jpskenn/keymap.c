...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    // |-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------|
                          KC_LALT,    GUI_EN, SP_SFT,     SP_LOW1,            BS_SFT, SP_RAI1,    GUI_JA, KC_ROPT
    //                   |-----------+-------+-----------+-------+-----------+-------+-----------+-------+-----------|
    ),
    [_BASE2] = LAYOUT(
    // |-------------------------------------------------------------------------------------------------------------------------------|
    ...
    // |-----------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-----------|
        KC_LSFT,KC_Z,   KC_X,   KC_C,   KC_V,   KC_B,   DM_PLY1,                DM_PLY2,KC_N,   KC_M,   KC_COMM,KC_DOT, KC_SLSH,KC_RSFT,
    // |-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------|
                          KC_LOPT,    CTL_EN, SP_SFT,     SP_LOW1,            BS_SFT, SP_RAI1,    GUI_JA, KC_LCTL
    //                   |-----------+-------+-----------+-------+-----------+-------+-----------+-------+-----------|
    ),
    [_BASE3] = LAYOUT(
    // |-------------------------------------------------------------------------------------------------------------------------------|
    ...
    [_RAISE1] = LAYOUT(
    // |-------------------------------------------------------------------------------------------------------------------------------|
        KC_ESC, KC_F1,  KC_F2,  KC_F3,  KC_F4,  KC_F5,  KC_F11,                 KC_F12, KC_F6,  KC_F7,  KC_F8,  KC_F9,  KC_F10, _______,
    // |-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------|
        KC_ESC,     KC_1,   KC_2,   KC_3,   KC_4,   KC_5,   _______,        _______,KC_6,   KC_7,   KC_8,   KC_9,   KC_0,   KC_DEL,
    // |-----------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-----------|
        _______,    KC_GRV, KC_EQL, KC_LBRC,KC_RBRC,KC_BSLS,_______,        KC_BTN3,KC_LEFT,KC_DOWN,KC_UP,  KC_RGHT,KC_SCLN,KC_QUOT,
    // |-----------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-----------|
        _______,_______,_______,_______,_______,_______,_______,                KC_WH_U,KC_HOME,KC_PGDN,KC_PGUP,KC_END, KC_VOLD,KC_VOLU,
    // |-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------|
                          _______,    _______,_______,    ADJUST,             KC_WH_D,_______,    _______,_______
    //                   |-----------+-------+-----------+-------+-----------+-------+-----------+-------+-----------|
    ),
    [_RAISE2] = LAYOUT(
    // |-------------------------------------------------------------------------------------------------------------------------------|
    ...
    [_ADJUST] = LAYOUT(
    // |-------------------------------------------------------------------------------------------------------------------------------|
        DM_RSTP,_______,_______,_______,_______,_______,_______,                _______,_______,_______,_______,KC_PSCR,KC_SCRL,KC_PAUS,
    // |-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------|
    ...
    // |-----------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-----------|
        _______,CK_TOGG,CK_RST, CK_DOWN,CK_UP,  _______,DM_REC1,                DM_REC2,_______,_______,_______,_______,_______,_______,
    // |-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------|
