...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE1] = LAYOUT_fw(
    // |-------------------------------------------------------------------------------------------------------------------------------|
        ESC_NUM,KC_1,   KC_2,   KC_3,   KC_4,   KC_5,   KC_GRV,                 KC_BSLS,KC_6,   KC_7,   KC_8,   KC_9,   KC_0,   KC_EQL,
    // |-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------|
    ...
    // |-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------|
                          KC_LOPT,    GUI_EN, SP_LOW1,    KC_BSPC,            KC_ENT, SP_RAI1,    GUI_JA, KC_ROPT
    //                   |-----------+-------+-----------+-------+-----------+-------+-----------+-------+-----------|
    ),
    [_BASE2] = LAYOUT_fw(
    // |-------------------------------------------------------------------------------------------------------------------------------|
    ...
    // |-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------|
        KC_TAB,     JP_Q,   JP_W,   JP_E,   JP_R,   JP_T,   JP_SCLN,        JP_LBRC,JP_Y,   JP_U,   JP_I,   JP_O,   JP_P,   KC_BSPC,
    // |-----------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-----------|
        C_ESC,      JP_A,   JP_S,   JP_D,   JP_F,   JP_G,   JP_COLN,        JP_RBRC,JP_H,   JP_J,   JP_K,   JP_L,   JP_MINS,KC_ENT,
    // |-----------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-----------|
        KC_LSFT,KC_LSFT,JP_Z,   JP_X,   JP_C,   JP_V,   JP_B,                   JP_AT,  JP_N,   JP_M,   JP_COMM,JP_DOT, JP_SLSH,JP_BSLS,
    // |-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------|
                          KC_LWIN,    KC_LALT,SP_LOW2,    KC_BSPC,            KC_ENT, SP_RAI2,    A_GRV,  KC_APP
    //                   |-----------+-------+-----------+-------+-----------+-------+-----------+-------+-----------|
    ),
    [_BASE3] = LAYOUT_fw(
    // |-------------------------------------------------------------------------------------------------------------------------------|
        _______,_______,_______,_______,_______,_______,_______,                _______,KC_PSLS,KC_PSLS,KC_PAST,KC_PMNS,_______,_______,
    // |-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------|
    ...
    // |-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------|
                          _______,    _______,SP_LOW3,    _______,            _______,_______,    KC_P0,  KC_PDOT
    //                   |-----------+-------+-----------+-------+-----------+-------+-----------+-------+-----------|
    ),
    [_LOWER1] = LAYOUT_fw(
    // |-------------------------------------------------------------------------------------------------------------------------------|
    ...
    // |-----------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-----------|
        _______,KC_MUTE,KC_VOLD,KC_VOLU,_______,_______,_______,                _______,JP_GRV, JP_PLUS,JP_ASTR,JP_LCBR,JP_RCBR,JP_UNDS,
    // |-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------|
                          _______,    _______,_______,    _______,            _______,ADJUST,     _______,_______
    //                   |-----------+-------+-----------+-------+-----------+-------+-----------+-------+-----------|
    ),
    ...
    // |-----------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-----------|
        KC_LSFT,KC_Z,   KC_X,   KC_C,   KC_V,   KC_B,   DM_PLY1,                DM_PLY2,KC_N,   KC_M,   KC_COMM,KC_DOT, KC_SLSH,KC_RSFT,
    // |-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------|
                          KC_LOPT,    KC_LCMD,_______,    KC_BSPC,            KC_ENT, ADJUST,     GUI_IME,KC_ROPT
    //                   |-----------+-------+-----------+-------+-----------+-------+-----------+-------+-----------|
    ),
    // [_RAISE1] = LAYOUT_fw(
    // // |-------------------------------------------------------------------------------------------------------------------------------|
    ...
    // |-------------------------------------------------------------------------------------------------------------------------------|
        KC_ESC, KC_F1,  KC_F2,  KC_F3,  KC_F4,  KC_F5,  _______,                KC_F12, KC_F6,  KC_F7,  KC_F8,  KC_F9,  KC_F10, KC_F11,
    // |-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------|
        KC_ESC,     KC_1,   KC_2,   KC_3,   KC_4,   KC_5,   _______,        KC_BTN2,KC_MS_L,KC_MS_D,KC_MS_U,KC_MS_R,KC_BTN1,   KC_DEL,
    // |-----------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-----------|
        _______,    KC_F1,  KC_F2,  KC_F3,  KC_F4,  KC_F5,  _______,        KC_BTN3,KC_LEFT,KC_DOWN,KC_UP,  KC_RGHT,KC_SCLN,KC_QUOT,
    // |-----------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-----------|
        _______,KC_F6,  KC_F7,  KC_F8,  KC_F9,  KC_F10, KC_F11,                 KC_WH_U,KC_HOME,KC_PGDN,KC_PGUP,KC_END, _______,_______,
    // |-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------|
                          _______,    _______,ADJUST,     KC_F12,             KC_WH_D,_______,    _______,_______
    //                   |-----------+-------+-----------+-------+-----------+-------+-----------+-------+-----------|
    ),
    [_RAISE2] = LAYOUT_fw(
    // |-------------------------------------------------------------------------------------------------------------------------------|
    ...
    // |-----------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-----------|
        _______,CK_TOGG,CK_RST, CK_DOWN,CK_UP,  _______,DM_REC1,                DM_REC2,_______,_______,_______,KC_PSCR,KC_SLCK,KC_PAUS,
    // |-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------|
...
//         KC_CAPS,       AU_TOG,   MU_TOG,   MU_MOD,   MUV_DE,   MUV_IN,   _______,            RGB_SPD,  RGB_HUD,  RGB_SAD,  RGB_VAD,  RGB_TOG,  RGB_MOD,       VERSION,
//         _______,  CK_TOGG,  CK_RST,   CK_DOWN,  CK_UP,    _______,  DM_REC1,                      DM_REC2,  NUM,      _______,  _______,  KC_PSCR,  KC_SLCK,  KC_PAUS,
//                                  _______,       _______,     _______,    _______,            _______,    _______,     _______,    _______,
//                                                                               _______,  _______
//     ),
// };
