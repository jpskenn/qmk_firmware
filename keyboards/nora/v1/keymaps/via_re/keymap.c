...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE1] = LAYOUT_re(
        ...
        C_ESC,         JP_A,     JP_S,     JP_D,     JP_F,     JP_G,               KC_MUTE,            JP_H,     JP_J,     JP_K,     JP_L,     JP_MINS,       KC_ENT,
    ...
    [_BASE2] = LAYOUT_re(
        ...
        C_ESC,         JP_A,     JP_S,     JP_D,     JP_F,     JP_G,               KC_MUTE,            JP_H,     KC_P4,    KC_P5,    KC_P6,    JP_MINS,       KC_ENT,
    ...
    [_LOWER] = LAYOUT_re(
        ...
        _______,       _______,  _______,  _______,  _______,  _______,            _______,            JP_AT,    JP_SCLN,  JP_COLN,  JP_LBRC,  JP_RBRC,       KC_BSLS,
    ...
    [_RAISE] = LAYOUT_re(
        ...
        _______,       KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,              _______,            KC_LEFT,  KC_DOWN,  KC_UP,    KC_RGHT,  JP_SCLN,       JP_COLN,
    ...
    [_ADJUST] = LAYOUT_re(
        ...
        KC_CAPS,       AU_TOG,   MU_TOG,   MU_MOD,   MUV_DE,   MUV_IN,             _______,            RGB_HUD,  RGB_SAD,  RGB_VAD,  RGB_TOG,  RGB_MOD,       VERSION,
