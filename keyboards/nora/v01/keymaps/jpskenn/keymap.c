...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_MAC] = LAYOUT(
        ESC_NUM,  KC_1,     KC_2,     KC_3,     KC_4,     KC_5,     KC_6,     KC_7,     KC_8,     KC_9,     KC_0,     KC_EQL,   KC_PSLS,  KC_PAST,  KC_PMNS,  KC_PPLS,
        ...
        DM_PLY1,  DM_PLY2,    KC_LOPT,     KC_LCMD,      SP_LOW,             SP_RAI,         GUI_IME,    KC_ROPT,     KC_LEFT,  KC_DOWN,  KC_RGHT,  KC_P0,    KC_PDOT
    ),
    [_WIN] = LAYOUT(
        _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,
           ...
           _______,    _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,    _______,     _______,  _______,  _______,
        _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,
        _______,  _______,    KC_LGUI,     KC_LALT,      _______,            _______,        A_GRV,      A_GRV,       _______,  _______,  _______,  _______,  _______
    ),
    [_NUM] = LAYOUT(
        ...
        _______,  _______,    _______,     _______,      SP_NLOW,            _______,        KC_P0,      KC_PDOT,     _______,  _______,  _______,  _______,  _______
    ),
    [_LOWER] = LAYOUT(
        ...
        _______,  _______,    _______,     _______,      _______,            SP_ADJ,         _______,    _______,     _______,  _______,  _______,  _______,  _______
    ),
    [_RAISE] = LAYOUT(
    ...
    [_NUM_LOWER] = LAYOUT(
        ...
        KC_VOLD,  KC_VOLU,    KC_LOPT,     KC_LCMD,      _______,            SP_ADJ,         GUI_IME,    KC_ROPT,     KC_LEFT,  KC_DOWN,  KC_RGHT,  KC_P0,    KC_PDOT
    ),
    [_ADJUST] = LAYOUT(
        DM_RSTP,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  KC_PSCR,  KC_SLCK,  KC_PAUS,
           _______,    MAC,      WIN,      _______,  _______,  _______,  RGB_HUI,  RGB_SAI,  RGB_VAI,  _______,  RGB_RMOD,   _______,     _______,  _______,  _______,
           _______,    AU_TOG,   CK_TOGG,  MU_TOG,   MU_MOD,   _______,  RGB_HUD,  RGB_SAD,  RGB_VAD,  RGB_TOG,  RGB_MOD,    VERSION,     _______,  _______,  _______,
        KC_CAPS,  KC_CAPS,  CK_RST,   CK_DOWN,  CK_UP,    MUV_DE,   MUV_IN,   _______,  _______,  NUM,      _______,  _______,  _______,  _______,  _______,  _______,
