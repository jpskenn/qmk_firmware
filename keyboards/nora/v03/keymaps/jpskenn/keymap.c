...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_ADJUST] = LAYOUT(
        ...
        KC_CAPS,  _______,  _______,  _______,  _______,  _______,  DM_REC1,  _______,  _______,  _______,  NUM,      _______,  _______,  _______,  _______,  _______,
                                 _______,       _______,     _______,    DM_REC2,  _______,  _______,    _______,     _______,    _______
    ),
};
