...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_MAC] = LAYOUT(
        ESC_NUM,  KC_1,     KC_2,     KC_3,     KC_4,     KC_5,     KC_PSLS,  KC_PAST,  KC_PMNS,  KC_PPLS,  KC_6,     KC_7,     KC_8,     KC_9,     KC_0,     KC_EQL,
        KC_TAB,        KC_Q,     KC_W,     KC_E,     KC_R,     KC_T,     KC_P7,    KC_P8,    KC_P9,    KC_Y,     KC_U,     KC_I,     KC_O,     KC_P,          KC_BSPC,
        C_ESC,         KC_A,     KC_S,     KC_D,     KC_F,     KC_G,     KC_P4,    KC_P5,    KC_P6,    KC_H,     KC_J,     KC_K,     KC_L,     KC_MINS,       KC_ENT,
        KC_LSFT,  KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     DM_PLY1,  KC_P1,    KC_P2,    KC_P3,    KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,  KC_RSFT,
                                 KC_LOPT,       KC_LCMD,     SP_LOW,     DM_PLY2,  KC_P0,    KC_PDOT,    SP_RAI,      GUI_IME,    KC_ROPT
    ),
    [_WIN] = LAYOUT(
        ...
        _______,       _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,       _______,
        _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,
                                 KC_LGUI,       KC_LALT,     _______,    _______,  _______,  _______,    A_GRV,       A_GRV,      _______
    ),
    [_NUM] = LAYOUT(
    ...
    [_LOWER] = LAYOUT(
        ...
        KC_ESC,        KC_EXLM,  KC_AT,    KC_HASH,  KC_DLR,   KC_PERC,  _______,  _______,  _______,  KC_CIRC,  KC_AMPR,  KC_ASTR,  KC_LPRN,  KC_RPRN,       KC_INS,
        _______,       _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  KC_GRV,   KC_MINS,  KC_EQL,   KC_LBRC,  KC_RBRC,       KC_BSLS,
        _______,  _______,  KC_MUTE,  KC_VOLD,  KC_VOLU,  _______,  _______,  _______,  _______,  _______,  KC_TILD,  KC_UNDS,  KC_PLUS,  KC_LCBR,  KC_RCBR,  KC_PIPE,
    ...
    [_RAISE] = LAYOUT(
        ...
        _______,  _______,  KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   _______,  _______,  _______,  KC_HOME,  KC_PGDN,  KC_PGUP,  KC_END,   KC_F11,   KC_F12,
                                 _______,       _______,     _______,    _______,  _______,  _______,    _______,     _______,    _______
    ),
    [_NUM_LOWER] = LAYOUT(
        KC_ESC,   KC_1,     KC_2,     KC_3,     KC_4,     KC_5,     KC_PSLS,  KC_PAST,  KC_PMNS,  KC_PPLS,  KC_6,     KC_7,     KC_8,     KC_9,     KC_0,     KC_EQL,
        KC_TAB,        KC_Q,     KC_W,     KC_E,     KC_R,     KC_T,     KC_P7,    KC_P8,    KC_P9,    KC_Y,     KC_U,     KC_I,     KC_O,     KC_P,          KC_BSPC,
        C_ESC,         KC_A,     KC_S,     KC_D,     KC_F,     KC_G,     KC_P4,    KC_P5,    KC_P6,    KC_H,     KC_J,     KC_K,     KC_L,     KC_MINS,       KC_ENT,
        KC_LSFT,  KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     KC_PIPE,  KC_P1,    KC_P2,    KC_P3,    KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,  KC_RSFT,
                                 KC_LOPT,       KC_LCMD,     _______,    KC_P0,    KC_P0,    KC_PDOT,    _______,     GUI_IME,    KC_ROPT
    ),
    [_ADJUST] = LAYOUT(
        DM_RSTP,  _______,  _______,  _______,  _______,  _______,  KC_PSCR,  KC_SLCK,  KC_PAUS,  _______,  _______,  _______,  _______,  _______,  _______,  _______,
        _______,       MAC,      WIN,      NUM,      _______,  _______,  _______,  _______,  _______,  RGB_HUI,  RGB_SAI,  RGB_VAI,  _______,  RGB_RMOD,      _______,
        _______,       _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  RGB_HUD,  RGB_SAD,  RGB_VAD,  RGB_TOG,  RGB_MOD,       VERSION,
        KC_CAPS,  _______,  _______,  _______,  _______,  _______,  DM_REC2,  _______,  _______,  _______,  NUM,      _______,  _______,  _______,  _______,  _______,
                                 _______,       _______,     _______,    DM_REC1,  _______,  _______,    _______,     _______,    _______
    ),
};
