...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    // |-----------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-----------|
        C_ESC,      MI_Cs,  MI_Ds,  XXXXXXX,MI_Fs,  MI_Gs,  MI_As,  XXXXXXX,MI_Cs_1,MI_Ds_1,XXXXXXX,MI_Fs_1,MI_Gs_1,MI_As_1,KC_ENT,
    // |-----------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-----------|
        MI_SUS, MI_C,   MI_D,   MI_E,   MI_F,   MI_G,   MI_A,   MI_B,   MI_C_1, MI_D_1, MI_E_1, MI_F_1, MI_G_1, MI_A_1, MI_B_1, MI_C_2,
    // |-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------|
                          _______,    _______,SP_LOW3,    MI_OCTD,MI_OCT_2,   MI_OCTU,SP_RAI1,    _______,_______
    //                   |-----------+-------+-----------+-------+-----------+-------+-----------+-------+-----------|
    ),
    [_BASE3] = LAYOUT(
    // |-------------------------------------------------------------------------------------------------------------------------------|
