...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_MAC] = LAYOUT(
        ...
        XXXXXXX,XXXXXXX,ALT_JA, GUI_EN, SP_LOW,             KC_BSPC,         SP_RAI, XXXXXXX,GUI_IME,  KC_LEFT,KC_DOWN,KC_RGHT
    ),
    [_WIN] = LAYOUT(
        _______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,
            ...
            _______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,
        _______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,
        _______,_______,KC_LGUI,KC_LALT,_______,            _______,        SP_RAI, XXXXXXX,ALT_GRV, _______,_______,_______
    ),
    [_NUM] = LAYOUT(
    ...
    [_RAISE] = LAYOUT(
        ...
        _______,_______,_______,_______,SP_ADJ,             _______,        _______,_______,_______,_______,_______,_______
    ),
    [_NUM_LOWER] = LAYOUT(
