...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_MAC] = LAYOUT(
        GRV_NUM,KC_1,   KC_2,   KC_3,   KC_4,   KC_5,   KC_6,   KC_BSLS,KC_6,   KC_7,   KC_8,   KC_9,   KC_0,   KC_MINS,KC_EQL,
            KC_TAB, KC_Q,   KC_W,   KC_E,   KC_R,   KC_T,   KC_LBRC,KC_RBRC,KC_Y,   KC_U,   KC_I,   KC_O,   KC_P,   KC_BSPC,
            C_ESC,  KC_A,   KC_S,   KC_D,   KC_F,   KC_G,   KC_SCLN,KC_QUOT,KC_H,   KC_J,   KC_K,   KC_L,   KC_MINS,KC_ENT,
        KC_LSFT,KC_LSFT,KC_Z,   KC_X,   KC_C,   KC_V,   KC_B,   KC_LEFT,KC_RGHT,KC_N,   KC_M,   KC_COMM,KC_DOT, S_SLSH, KC_RCTL,
        XXXXXXX,XXXXXXX,KC_LOPT,KC_LCMD,SP_LOW,             KC_ENT ,         SP_RAI, XXXXXXX,GUI_IME,  KC_ROPT,KC_LEFT,KC_RGHT
    ),
    [_WIN] = LAYOUT(
        _______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,
            _______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,
            _______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,
        _______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,KC_UP,
        _______,_______,KC_LGUI,KC_LALT,_______,            _______,        _______, _______,ALT_GRV, KC_LEFT,KC_DOWN,KC_RGHT
    ),
    [_NUM] = LAYOUT(
        KC_GRV,_______,_______,_______,_______,_______,_______,_______,_______,KC_PSLS,KC_PSLS,KC_PSLS,KC_PAST,_______,_______,
        ...
        _______,_______,_______,_______,SP_NLOW,            _______,        _______,_______,KC_P0,  KC_PDOT,_______,_______
    ),
    [_LOWER] = LAYOUT(
        _______,KC_F1,  KC_F2,  KC_F3,  KC_F4,  KC_F5,  KC_F6,  KC_INS, KC_DEL, KC_F7,  KC_F8,  KC_F9,  KC_F10, KC_F11, KC_F12,
            KC_ESC, KC_EXLM,KC_AT,  KC_HASH,KC_DLR, KC_PERC,_______,_______,KC_CIRC,KC_AMPR,KC_ASTR,KC_LPRN,KC_RPRN,KC_DEL,
            _______,M_PSCR, KC_SLCK,KC_PAUS,_______,_______,_______,_______,KC_GRV, KC_MINS,KC_EQL, KC_LBRC,KC_RBRC,KC_BSLS,
        _______,_______,KC_MUTE,KC_VOLD,KC_VOLU,_______,_______,_______,_______,KC_TILD,KC_UNDS,KC_PLUS,KC_LCBR,KC_RCBR,KC_PIPE,
        _______,_______,_______,_______,_______,            _______,        SP_ADJ, _______,_______,_______,_______,_______
    ),
    [_RAISE] = LAYOUT(
        KC_GRV, KC_F1,  KC_F2,  KC_F3,  KC_F4,  KC_F5,_______,_______,KC_F6,  KC_F7,  KC_F8,  KC_F9,  KC_F10, KC_F11, KC_F12,
            ...
            _______,KC_F1,  KC_F2,  KC_F3,  KC_F4,  KC_F5,  KC_F6,  _______,KC_LEFT,KC_DOWN,KC_UP,  KC_RGHT,KC_SCLN,KC_QUOT,
        _______,_______,KC_F7,  KC_F8,  KC_F9,  KC_F10, KC_F11, KC_F12, _______,KC_HOME,KC_PGDN,KC_PGUP,KC_END, KC_COLN,KC_DQUO,
        _______,_______,_______,_______,SP_ADJ,             _______,        _______,_______,_______,_______,KC_DOWN,KC_UP
    ),
    [_NUM_LOWER] = LAYOUT(
        KC_GRV, KC_1,   KC_2,   KC_3,   KC_4,   KC_5,   KC_6,   KC_GRV, KC_BSLS,KC_7,   KC_8,   KC_9,   KC_0,   KC_MINS,KC_EQL,
            KC_TAB, KC_Q,   KC_W,   KC_E,   KC_R,   KC_T,   KC_LBRC,KC_RBRC,KC_Y,   KC_U,   KC_I,   KC_O,   KC_P,   KC_BSPC,
            C_ESC,  KC_A,   KC_S,   KC_D,   KC_F,   KC_G,   KC_SCLN,KC_QUOT,KC_H,   KC_J,   KC_K,   KC_L,   KC_SCLN, KC_ENT,
        KC_LSFT,KC_LSFT,KC_Z,   KC_X,   KC_C,   KC_V,   KC_B,   KC_LEFT,KC_RGHT,KC_N,   KC_M,   KC_COMM,KC_DOT, S_SLSH, KC_UP,
            _______,_______,_______,_______,_______,        _______,        SP_ADJ, _______,_______,KC_LEFT,KC_DOWN,KC_RGHT
    ),
    [_ADJUST] = LAYOUT(
        _______,RGB_HUI,RGB_SAI,RGB_VAI,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,
            ...
            _______,_______,_______,_______,_______,_______,_______,_______,RGB_HUD,RGB_SAD,RGB_VAD,RGB_TOG,RGB_MOD, _______,
        KC_CAPS,KC_CAPS,_______,_______,_______,_______,_______,_______,_______,NUM,    MAC,    _______,_______,_______,_______,
...
void keyboard_post_init_user(void) {
    ...
    rgblight_sethsv_range(HSV_BLACK, 2, 4);
