...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_MAC] = LAYOUT(
        ...
        XXXXXXX,XXXXXXX,ALT_JA, GUI_EN, SP_LOW,             KC_ENT,         SP_RAI, XXXXXXX,GUI_IME,  KC_LEFT,KC_DOWN,KC_RGHT
    ),
    [_WIN] = LAYOUT(
    ...
    [_LOWER] = LAYOUT(
        ...
        _______,_______,KC_APP, _______,_______,            _______,        SP_ADJ, _______,_______,_______,_______,_______
    ),
    [_RAISE] = LAYOUT(
