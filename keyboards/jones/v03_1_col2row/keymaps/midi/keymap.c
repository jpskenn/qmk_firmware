...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_MAC] = LAYOUT_all(
        ...
        S_CAP,          KC_Z,   KC_X,   KC_C,   KC_V,   KC_B,   KC_N,   KC_M,   KC_COMM,KC_DOT, KC_SLSH,KC_RSFT,XXXXXXX,LOWER,
        XXXXXXX,XXXXXXX,KC_LALT,KC_LGUI,       KC_SPC,         SP_RAI,         KC_RGUI,KC_RALT,XXXXXXX,XXXXXXX,  HENKAN, XXXXXXX
    ),
    [_WIN] = LAYOUT_all(
        ...
        _______,    _______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,    _______,_______,
        _______,        _______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,
        _______,XXXXXXX,KC_LGUI,KC_LALT,        _______,        _______,        KC_RALT,KC_APP, XXXXXXX,_______,_______,_______
    ),
    [_NUM] = LAYOUT_all(
    ...
    [_MIDI] = LAYOUT_all(
        XXXXXXX,MI_Fs_3,MI_Gs_3,MI_As_3,XXXXXXX,MI_Cs_4,MI_Ds_4,XXXXXXX,MI_Fs_4,MI_Gs_4,MI_As_4,XXXXXXX,MI_Cs_5,MI_Ds_5,XXXXXXX,
        MI_F_3,     MI_G_3, MI_A_3, MI_B_3, MI_C_4, MI_D_4, MI_E_4, MI_F_4, MI_G_4, MI_A_4, MI_B_4, MI_C_5,     MI_D_5, MI_E_5,
        _______,    MI_Fs_2,MI_Gs_2,MI_As_2,XXXXXXX,MI_Cs_3,MI_Ds_3,XXXXXXX,MI_Fs_3,MI_Gs_3,MI_As_3,XXXXXXX,    MI_Cs_4,MI_Ds_4,
        MI_F_2,         MI_G_2, MI_A_2, MI_B_2, MI_C_3, MI_D_3, MI_E_3, MI_F_3, MI_G_3, MI_A_3, MI_B_3, MI_C_4, XXXXXXX,_______,
    ...
    [_ADJUST] = LAYOUT_all(
        ...
        _______,    MIDI,   WIN,    _______,RESET,  _______,RGB_HUI,RGB_SAI,RGB_VAI,_______,RGB_RMOD,_______,   _______,_______,
...
const rgblight_segment_t PROGMEM my_caps_layer[] = RGBLIGHT_LAYER_SEGMENTS(
    {JONES_LED_INDICATOR_INDEX + 1 , JONES_LED_INDICATOR_CHANGE_COUNT, HSV_MAGENTA - JONES_LED_DIMMER_LEVEL}
);
