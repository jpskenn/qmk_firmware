...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_MAC] = LAYOUT(
        ...
        XXXXXXX,  XXXXXXX,  KC_LOPT,     GUI_EN,        SP_SFT,        SP_LOW,  BS_SFT,      SP_RAI,GUI_JA,         GUI_JA,     KC_ROPT,  XXXXXXX,  XXXXXXX,
    ...
    [_NUM] = LAYOUT(
        KC_ESC,   _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  KC_PSLS,  KC_PSLS,  KC_PAST,  KC_PMNS,  KC_PMNS,  _______,
           ...
           _______,     _______,  _______,  _______,  _______,  _______,  _______,  _______,  S(KC_TAB),KC_P4,    KC_P5,    KC_P6,    KC_PPLS,   _______,
        _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  KC_P1,    KC_P2,    KC_P3,    XXXXXXX,  _______,
        _______,  _______,  _______,     _______,       _______,       SP_NLOW,  _______,     _______,_______,      KC_P0,      KC_PDOT,  _______,  _______,
        _______,  _______,                                                                                                                _______,  _______
    ),
    [_LOWER] = LAYOUT(
    ...
    [_RAISE] = LAYOUT(
        KC_F11,   KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,    _______,  _______,  _______,  KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F12,
            ...
            KC_MUTE,    KC_GRV,   KC_EQL,   KC_LBRC,  KC_RBRC,  KC_BSLS,  _______,  _______,  KC_LEFT,  KC_DOWN,  KC_UP,    KC_RGHT,  KC_SCLN,  KC_QUOT,
    ...
    [_NUM_LOWER] = LAYOUT(
        ...
        XXXXXXX,  XXXXXXX,  KC_LOPT,     GUI_EN,        SP_SFT,        _______,  BS_SFT,     _______,GUI_JA,        GUI_JA,     KC_ROPT,  XXXXXXX,  XXXXXXX,
        KC_VOLD,  KC_VOLU,                                                                                                                KC_PGDN,  KC_PGUP
    ),
    [_ADJUST] = LAYOUT(
        DM_RSTP,  MAC_SLP,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  KC_PSCR,  KC_SLCK,  KC_PAUS,
            KEY_WAIT,   MAC,      WIN,      _______,  RESET,    _______,  _______,  _______,  RGB_HUI,  RGB_SAI,  RGB_VAI,  _______,  RGB_RMOD,  KC_INS,
            KC_CAPS,    _______,  _______,  _______,  _______,  _______,  _______,  _______,  RGB_HUD,  RGB_SAD,  RGB_VAD,  RGB_TOG,  RGB_MOD,   VERSION,
        XXXXXXX,  KC_CAPS,  _______,  _______,  _______,  _______,  DM_REC1,  _______,  DM_REC2,  NUM,      _______,  _______,  _______,  _______,  _______,
        _______,  _______,  _______,     _______,        _______,      _______,   _______,   _______,_______,      _______,     _______,  _______,  _______,
        _______,  _______,                                                                                                                _______,  _______
    ),
};
