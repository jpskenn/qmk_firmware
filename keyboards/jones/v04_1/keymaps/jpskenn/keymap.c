...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_MAC] = LAYOUT(
        ...
        KC_MUTE,  KC_LANG2, KC_LOPT,     KC_LCMD,       SP_LOW,        KC_ENT,   KC_BSPC,     SP_RAI,GUI_IME,       GUI_IME,    KC_LEFT,  KC_DOWN,  KC_RGHT,
    ...
    [_NUM_LOWER] = LAYOUT(
        ...
        _______,  _______,  _______,     _______,        _______,      _______,  _______,     SP_ADJ,_______,      _______,     KC_LEFT,  KC_DOWN,  KC_RGHT,
        _______,  _______,                                                                                                                _______,  _______
    ),
    [_ADJUST] = LAYOUT(
