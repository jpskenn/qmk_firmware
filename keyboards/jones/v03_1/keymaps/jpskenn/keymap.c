...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_MAC] = LAYOUT_all(
        ...
        XXXXXXX,XXXXXXX,KC_LALT,KC_LGUI,       KC_SPC,         BS_RAI,         KC_RGUI,KC_RALT,XXXXXXX,XXXXXXX, HENKAN, XXXXXXX
    ),
    [_WIN] = LAYOUT_all(
    ...
    [_NUM] = LAYOUT_all(
        ...
        _______,_______,_______,_______,        _______,        BS_NRAI,        KC_P0,  KC_PDOT,_______,_______,_______,_______
    ),
    [_LOWER] = LAYOUT_all(
