...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_NUM] = LAYOUT_all(
        ...
        _______,_______,_______,_______,        SP_NLOW,        _______,        KC_P0,  KC_PDOT,_______,_______,_______,_______
    ),
    [_LOWER] = LAYOUT_all(
        ...
        _______,    M_PSCR, KC_SLCK,KC_PAUS,_______,_______,KC_GRV, KC_MINS,KC_EQL, KC_LBRC,KC_RBRC,KC_BSLS,    _______,KC_HOME,
        _______,        KC_MUTE,KC_VOLD,KC_VOLU,_______,_______,KC_TILD,KC_UNDS,KC_PLUS,KC_LCBR,KC_RCBR,KC_PIPE,_______,KC_END,
    ...
    [_RAISE] = LAYOUT_all(
        ...
        _______,    KC_F1,  KC_F2,  KC_F3,  KC_F4,  KC_F5,  KC_LEFT,KC_DOWN,KC_UP,  KC_RGHT,KC_SCLN,KC_QUOT,    _______,KC_HOME,
        _______,        KC_F6,  KC_F7,  KC_F8,  KC_F9,  KC_F10, KC_HOME,KC_PGDN,KC_PGUP,KC_END, KC_COLN,KC_DQUO,_______,KC_END,
    ...
    [_NUM_LOWER] = LAYOUT_all(
        ...
        KC_TAB,     KC_Q,   KC_W,   KC_E,   KC_R,   KC_T,   KC_Y,   KC_U,   KC_I,   KC_O,   KC_P,   KC_BSPC,    KC_LBRC,KC_RBRC,
        C_ESC,      KC_A,   KC_S,   KC_D,   KC_F,   KC_G,   KC_H,   KC_J,   KC_K,   KC_L,   KC_MINS, KC_ENT,    KC_QUOT,KC_PGUP,
        _______,        KC_Z,   KC_X,   KC_C,   KC_V,   KC_B,   KC_N,   KC_M,   KC_COMM,KC_DOT, KC_SLSH,KC_RSFT,KC_RCTL,KC_PGDN,
        _______,_______,_______,_______,        _______,        SP_ADJ,         _______,_______,_______,_______,_______,_______
    ),
    [_ADJUST] = LAYOUT_all(
        _______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,
        ...
        KC_CAPS,        CK_RST, CK_DOWN,CK_UP  ,MUV_DE, MUV_IN, NUM,     MAC,   _______,_______,_______,_______,_______,_______,
...
#define JONES_LED_DIMMER_LEVEL 180          // brightness dimmer
