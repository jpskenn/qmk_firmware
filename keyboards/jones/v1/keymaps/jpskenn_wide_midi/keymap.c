...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_WIN] = LAYOUT(
        _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,
           ...
           _______,     MI_Fs,    MI_Gs,    MI_As,    _______,  MI_Cs_1,  MI_Ds_1,  _______,  MI_Fs_1,  MI_Gs_1,  MI_As_1,  _______,  MI_Cs_2,   MI_Ds_2,
        MI_E,     MI_F,     MI_G,     MI_A,     MI_B,     MI_C_1,   MI_D_1,   MI_E_1,   MI_F_1,   MI_G_1,   MI_A_1,   MI_B_1,   MI_C_2,   MI_D_2,   MI_E_2,
        _______,  _______,  KC_LGUI,     KC_LALT,        _______,      _______,  _______,     _______,A_GRV,        A_GRV,      _______,  _______,  _______,
        MI_OCTD,  MI_OCTU,                                                                                                                _______,  _______
    ),
    [_NUM] = LAYOUT(
    ...
    [_NUM_LOWER] = LAYOUT(
        ...
        XXXXXXX,  XXXXXXX,  KC_LOPT,     KC_LCMD,       _______,       KC_ENT,   KC_BSPC,     ADJUST,GUI_IME,       GUI_IME,    KC_ROPT,  XXXXXXX,  XXXXXXX,
        KC_VOLD,  KC_VOLU,                                                                                                                KC_PGDN,  KC_PGUP
    ),
    [_ADJUST] = LAYOUT(
