...
//-----------------+---------+---------+-----------+---------| |---------+---------+-----------+---------------------------//
                    ESC_CTL,  LNG2_GUI, _______,    _______,    _______,  _______,  LNG1_GUI,   ESC_ALT
),
[_NUM] = LAYOUT(
//----+---------+---------+---------+---------+---------+----| |----+---------+---------+---------+---------+---------+----//
...
//-----------------+---------+---------+-----------+---------| |---------+---------+-----------+---------------------------//
                    _______,  _______,  _______,    ADJUST,     KC_DEL,   _______,  KC_VOLD,    KC_VOLU
),
[_SPECIAL] = LAYOUT(
//----+---------+---------+---------+---------+---------+----| |----+---------+---------+---------+---------+---------+----//
       _______,  _______,  _______,  _______,  _______,              WIN_PSCR, _______,  _______,  _______,  MAC_PSCR,
//----+---------+---------+---------+---------+---------+----| |----+---------+---------+---------+---------+---------+----//
       _______,  _______,  _______,  _______,  DM_PLY1,              DM_PLY2,  _______,  _______,  _______,  _______,
//---------+---------+---------+---------+---------+---------| |---------+---------+---------+---------+---------+---------//
   _______,  _______, _______,  _______,  _______,  _______,    _______,  _______,  _______,  _______,  _______,  _______,
//-----------------+---------+---------+-----------+---------| |---------+---------+-----------+---------------------------//
...
[_ADJUST] = LAYOUT(
//----+---------+---------+---------+---------+---------+----| |----+---------+---------+---------+---------+---------+----//
       BASE1,    BASE2,    TG_NUM,   MAC_SLP,  _______,             CNT_TOG,  UG_SATU,  UG_VALU,  IND_TOG,  UG_NEXT,
//----+---------+---------+---------+---------+---------+----| |----+---------+---------+---------+---------+---------+----//
